...
const WhyJerichoPage = () => {
  return (
    <div>
      ...
      <section className="py-24 bg-[#F8F6F1]">
        <div className="container mx-auto px-4">
          <motion.div {...fadeIn} transition={{ duration: 0.6 }} className="max-w-3xl">
            ...
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-semibold italic mb-6 text-foreground leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {processSteps.map((step, i) => (
              <motion.div
                ...
                {...fadeIn}
                transition={{ duration: 0.4, delay: i * 0.1 }}
                className="bg-white border border-[#E5E2DB] shadow-card p-7"
              >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <motion.div {...fadeIn} transition={{ duration: 0.4 }} className="bg-white border border-[#E5E2DB] shadow-card p-8">
              ...
              <ul className="space-y-3">
                {suitableFor.map((item, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm text-muted-foreground">
                    <span className="w-1.5 h-1.5 bg-green-600 mt-1.5 shrink-0" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <motion.div {...fadeIn} transition={{ duration: 0.4, delay: 0.1 }} className="bg-white border border-[#E5E2DB] shadow-card p-8">
              <h3 className="font-serif text-xl font-bold mb-6 text-foreground flex items-center gap-2">
      ...
      {/* CTA - Keep dark as contrast anchor */}
