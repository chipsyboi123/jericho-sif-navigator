        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {pillars.map((pillar, i) => (
              <div
                key={i}
                className="glass-card rounded-2xl p-8 hover:shadow-card-hover hover:border-gold/30 transition-all animate-fadeIn"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {processSteps.map((step, i) => (
              <div
                key={i}
                className="bg-white/70 backdrop-blur-sm border border-border rounded-2xl shadow-card p-7 animate-fadeIn"
                style={{ animationDelay: `${i * 100}ms` }}
              >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="glass-card rounded-2xl p-8 animate-fadeIn-delay-1">
              <h3 className="font-heading text-xl font-bold mb-6 text-foreground flex items-center gap-2">
